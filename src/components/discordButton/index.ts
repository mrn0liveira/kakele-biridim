...
export function MARKETPLACE_ADD_VALUE_MONEY_VALUE (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Secondary)
...
export function MARKETPLACE_VIEW_FILTER_BY_SERVER (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Primary)
...
export function MARKETPLACE_VIEW_FILTER_BY_EQUIPMENT (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Primary)
...
export function MARKETPLACE_VIEW_SELECT_ITEM_CHAT (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
...
export function MARKETPLACE_VIEW_SELECT_ITEM_REPORT (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
...
export function NOTIFICATION_BUTTON_MAINMENU_SETTINGS (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Primary)
...
export function NOTIFICATION_BUTTON_MAINMENU_EXIT (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
...
export function NOTIFICATION_BUTTON_EVENT_CLEAR_CHANNEL (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
...
export function NOTIFICATION_BUTTON_EVENT_CLEAR_ROLE (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
...
export function NOTIFICATION_BUTTON_EVENT_CLEAR_INDEX (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
...
export function NOTIFICATION_BUTTON_EVENT_CLEAR_INDEX_ADD (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
...
export function NOTIFICATION_BUTTON_EVENT_CLEAR_GUILD (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
...
export function NOTIFICATION_BUTTON_EVENT_GENERIC_SERVER_SELECTION (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Primary)
...
export function NOTIFICATION_BUTTON_EVENT_CONFIRM (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Success)
...
export function NOTIFICATION_BUTTON_EVENT_SETTINGS_BACK (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
...
export function NOTIFICATION_BUTTON_EVENT_ROLE_SET_EVERYONE (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Primary)
...
export function NOTIFICATION_BUTTON_EVENT_SETTINGS_CLEAR_EVERYONE (label: string): ButtonBuilder {
  const button = new ButtonBuilder()
    .setLabel(label)
    .setStyle(ButtonStyle.Danger)
