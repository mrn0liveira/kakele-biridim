...
import type { KakeleMonster, KakeleItem, UserRateLimit, SupportedLanguages } from './misc.ts'
...
export default class Biridim extends Client {
  ...
  public getKakeleItemEmoji (item: string): string {
    const itemNameWithoutSpecialChars = item.replace(/[^A-Z0-9]/ig, '')
  ...
  public translate (phrase: string, locale: SupportedLanguages, options?: any): string {
