import { Schema, type Document, type Model, model, type Types, type PopulatedDoc } from 'mongoose'
...
const OfferItemSchema: Schema<IOfferItemDocument> = new Schema<IOfferItemDocument>({
...
export const MarketplaceItem: Model<IOfferItemDocument> = model<IOfferItemDocument>('OfferItem', OfferItemSchema)
