    ...
    await interaction.editReply({
      embeds: [
        new CustomEmbed()
          ...
          .setDescription(client.translate('COMMAND_REPORT_DESCRIPTION', args.language, { date: args.user.vip_data?.expiration_date !== undefined ? `<t:${Math.floor(new Date(args.user.vip_data.expiration_date).getTime() / 1000)}>` : '` `' }))
